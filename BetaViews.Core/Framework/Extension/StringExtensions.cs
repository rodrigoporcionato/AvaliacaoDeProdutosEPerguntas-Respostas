...
namespace BetaViews.Core.Framework.Extension
{
    public static class StringExtensions
    {
        ...
        public static double RoundScore(double exactScore)
        {

            var roundedScore = 0.0;

            if (exactScore >= 4.75)
            {
                roundedScore = 5.0;
            }
            else if (exactScore >= 4.25)
            {
                roundedScore = 4.5;
            }
            else if (exactScore >= 3.75)
            {
                roundedScore = 4.0;
            }
            else if (exactScore >= 3.25)
            {
                roundedScore = 3.5;
            }
            else if (exactScore >= 2.75)
            {
                roundedScore = 3.0;
            }
            else if (exactScore >= 2.25)
            {
                roundedScore = 2.5;
            }
            else if (exactScore >= 1.75)
            {
                roundedScore = 2.0;
            }
            else if (exactScore >= 1.25)
            {
                roundedScore = 1.5;
            }
            else if (exactScore >= 0.75)
            {
                roundedScore = 1.0;
            }
            else if (exactScore >= 0.25)
            {
                roundedScore = 0.5;
            }
            else
        ...
        /// <summary>
        /// Retorna a pontuacao media do produto ou loja
        /// </summary>
        public static double RetornaClassificacaoGeral(this int s1, int s2, int s3, int s4, int s5, int totalAvaliacoes)
        {
            double classificacaoGeral=0;
            double mp = 0;
            mp = mp + (s1 * 1);
            mp = mp + (s2 * 2);
            mp = mp + (s3 * 3);
            ...
            {                
                ...
                classificacaoGeral = Math.Round(PontuacaoMedia, 1);

                return RoundScore(classificacaoGeral);
            }
            return 0;
        }
        /// <summary>
        /// Percentual de pessoas que recomendam o produto
        /// </summary>
        public static double RetornaTotalRecomendaProduto(this double totalRecomenda, int totalAvaliacoes) {

            if (totalRecomenda > 0 && totalAvaliacoes > 0)
            {
                return Math.Round(100 * totalRecomenda / totalAvaliacoes);
            }
        ...
        public static string RemoveDiacriticsLower(this String s)
        {
            s = !string.IsNullOrEmpty(s) ? s.ToLower() : s;
        ...
        public static string GetPercentageString(this double ratio)
        {
            return ratio.ToString("0.0%");
        }

        /// <summary>
        /// verifica se data em string é uma DATA VALIDA
        /// </summary>
        ...
        public static string ToYesOrNoStr(this bool v)
        {
            return v ? "Sim" : "Não";        
        }

        public static string ToYesOrNoStr(this int v)
        {
            return v == 1 ? "Sim" : "Não";
        }
        ...
        /// <param name="v"></param>
        /// <returns></returns>
        public static string ToNullString(this string v) {
        ...
        public static string ToCSV<T>(this IEnumerable<T> source, char separator)
        {
            ...
            source.ToList().ForEach(value => csv.AppendFormat("{0}{1}", value, separator));
        ...
        public static bool matchWholeWord(this string search, string test)
        {
